            ...
            <tbody>
                ...
                foreach($view['alugueis'] as $aluguel) {?>
                    <tr class="position-relative">
                        ...
                        <td class="text-center"><a class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#modalDevolucao" onclick="setarCamposModal(`<?=$aluguel->get('id')?>`, `<?=$aluguel->get('valor_aluguel')?>`, `<?=$aluguel->get('valor_entrada')?>`, `<?=$aluguel->get('valor_restante')?>`)"><i class="ti ti-calendar-plus"></i></a></td>
                    </tr>
                <?php } ?>
            </tbody>
        </table>
