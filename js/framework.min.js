...
/* reveal */
function reveal(){for(var e=document.querySelectorAll(".reveal"),t=0;t<e.length;t++){var a,i=window.innerHeight;e[t].getBoundingClientRect().top<i-0?e[t].classList.add("active"):e[t].classList.remove("active")}}window.addEventListener("scroll", reveal);

/* others */
window.addEventListener("scroll",reveal),AOS.init({disable:function(){return window.innerWidth<768}}),$.fn.moveIt=function(){var t=$(window),e=[];$(this).each(function(){e.push(new moveItItem($(this)))}),window.addEventListener("scroll",function(){if($(window).width()>770){var n=t.scrollTop();e.forEach(function(t){t.update(n)})}},{passive:!0})};var moveItItem=function(t){this.el=$(t),this.speed=parseInt(this.el.attr("data-scroll-speed"))};moveItItem.prototype.update=function(t){this.el.css("transform","translateY("+-(t/this.speed)+"px)")};
